...
'''
script responsavel por realizar ajustes nos nomes do arquivos.
tal etepa foi necessaria pois o banco de metadados foi formado a partir do nome dos arquivos
'''
