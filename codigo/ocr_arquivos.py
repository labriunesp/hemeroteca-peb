...
def origem_tif():
    ...
    destino_raiz = '/media/hdvm08/bd/002/997/001/pdf'
            if "tif" in arq:
                ...
                if "07-brasil-eua" or "08-brasil-europa" or "09-brasil-informatica_e_direitos_autorais" or "10-brasil-meio_ambiente" or "11-brasil-oriente_medio" or "12-brasil-politica_exterior" in origem_caminho_tif: 
